...
<div class="sidebar">
    ...
    <div class="ob">
        <h1 style ="font-size : 70px ; margin-top : 4rem ; margin-left : -5rem ;">HP</h1>
            <div class="ava">
    ...
    border-radius : 0% ;">
        ...
        <?php foreach( $datas as $data) { ?>
            ...
            <i class="fa-solid fa-mobile-screen-button fa-5x" style="color: #b2bac7; margin-left : 0.3rem ; margin-top : 1rem ; margin-bottom: 1rem ;"></i>
                <p style = "text-align : left ; margin-left : 0.5rem;">no HP &nbsp; &nbsp;  : <?= $data["nomor"]?></p>
                <p style = "text-align : left ; margin-left : 0.5rem;">status   &emsp;: <?= $data["status"]?></p>
            </button>
        <?php }?>
        </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <i class="fa-solid fa-mobile-screen-button fa-5x" style="color: #b2bac7; margin-left : 2rem ; margin-top : 1rem ; margin-bottom: 1rem ;"></i>
        <h2 style = "margin-left : 7.5rem ; margin-top : -3.5rem ;">Handphone</h2>
        <input name="nomor" class="form-control" type="text" placeholder="no handphone" aria-label="default input example" style = "margin-top : 1rem ; margin-left : 1rem ; width : 200px ;">
      </div>
...
<?php 
    if(isset($_POST['submit'])) { 
        ...
        $result = mysqli_query($server, $sql);
        if ($result) {
            $sql = "UPDATE hp SET status = 'dipinjam' WHERE nomor = '$nomor'";
            $result = mysqli_query($server, $sql);
        }
    }
?>
